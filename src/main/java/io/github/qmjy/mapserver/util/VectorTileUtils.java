...
public class VectorTileUtils {
    ...
    public static Optional<JtsMvt> decodeJtsMvt(InputStream inputStream) {
        try {
            return Optional.of(MvtReader.loadMvt(inputStream, geomFactory, new TagKeyValueMapConverter()));
        } catch (IOException e) {
